import 'package:catalog_app_cart_view/cart_view/cart_list_view.dart';
import 'package:catalog_app_cart_view/components/my_drawer.dart';
import 'package:catalog_app_cart_view/components/network_widget_img.dart';
import 'package:catalog_app_cart_view/modal/item_modals.dart';
          ...
          PersistentShoppingCart().showCartItemCountWidget(
            cartItemCountWidgetBuilder: (itemCount) => IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const CartViewList()),
                );
              },
              icon: Badge(
                                    ...
                                    Align(
                                      ...
                                      child: PersistentShoppingCart()
                                        ...
                                        product: PersistentShoppingCartItem(
                                            ...
                                            productName:
                                                itemsList[index].productName,
                                            productDescription: itemsList[index]
                                                .productDescription,
                                            unitPrice: double.parse(
                                                itemsList[index]
                                                    .unitPrice
                                                    .toString()),
                                            productThumbnail: itemsList[index]
                                                .productThumbnail
                                                .toString(),
                                            quantity: 2),
                                      ),
